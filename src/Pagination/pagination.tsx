...
import type { PaginationProps, OmitPageProps } from './interface';
        ...
        Array.from({ length: 9 - 2 }).map((_, index) => {
          ...
          return (
            <li
              ...
              onClick={(): void => {
                if (activePage !== index + totalPagesCount - 9 + 3) {
        ...
        Array.from({ length: 9 - 4 }).map((_, index) => {
          ...
          return (
            <li
              ...
              key={index + current - 1}
              onClick={(): void => {
                if (activePage !== index + current - 2) {
                  handlePageChange(index + current - 2);
                }
              }}
            >
